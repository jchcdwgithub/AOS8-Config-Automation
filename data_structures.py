COL_TO_ATTR = {"RF Profile":["ap_g_radio_prof.profile-name","ap_a_radio_prof.profile-name","reg_domain_prof.profile-name"],
               ...
               "MGMT Int VLAN":['int_mgmt.int_mgmt_ip.vlan'],
               ...
               "SNMPv2c Server Host Port":['snmp_ser_host_snmpv2c.port'],
               ...
               "Rad Server AcctPort":['rad_server.rad_accport.accport'],
               ...
               "CP Default Role":['ap_auth_prof.cp_default_role.cp-default-role'],
               "CP User Logon":['ap_auth_prof.allow_user'],
               "CP Whitelist":['ap_auth_prof.allow_user.cp_white_list.white-list'],
               ...
               "Wired Port AAA Prof":['wired_port.wired_port_aaa.profile-name'],
